 ...
 *
 * $Id: md5.c,v 1.4 2006/08/08 13:31:35 fab Exp $
 */
 ...
 */
void MD5Update (MD5_CTX *mdContext, CONST_STRPTR inBuf,
					   unsigned int inLen)
{
	register int i, ii;
	int mdi;
 ...
 */
void MD5Final (TEXT digest[16], MD5_CTX *mdContext)
{
	ULONG in[16];
	int mdi;
	unsigned int i, ii;
