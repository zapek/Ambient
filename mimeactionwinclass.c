...
DEFNEW
{
	obj = DoSuperNew(cl, obj,
		...
		WindowContents, NewObject(getmimeactiongroupclass(), NULL, TAG_MORE, INITTAGS),
	End;
...
DEFTMETHOD(Mimeactionwin_Close)
{
...
DECNEW
DECGET
DECTMETHOD(Mimeactionwin_Close)
ENDMTABLE

DECSUBCLASS_NC(MUIC_Window, mimeactionwinclass)
