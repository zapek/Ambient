 ...
 *
 * $Id: am_gfx_scale.c,v 1.1 2026/01/25 17:39:37 kronos Exp $
 */
...
static ULONG gsi_scale_nearest_neighbour(struct gsi_info *gsii , CONST ULONG *s, ULONG x , ULONG y)
{
	return (*s);
}
...
ULONG gfx_scale(APTR sbm, APTR tbm, ULONG txs, ULONG tys, ...)
{
	...
	va_end(args);
	return v_gfx_scale(sbm,tbm,txs,tys, ti);
}
/*
