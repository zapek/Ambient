 ...
 *
 * $Id: lib.c,v 1.6 2017/07/29 16:26:49 piru Exp $
 */
 ...
 */
#define LIBNAME      "about.amod"
#define LIBCOPYRIGHT "© 2003-2004 David Gerber, © 2005-2006 Ambient Open Source Team"
#define LIBPRI 0
#define LIBBASE AboutBase
