 ...
 *
 * $Id: gfx_linedraw.c,v 1.1 2015/03/02 13:50:54 geit Exp $
 */
...
void LIB_gfx_LineDrawAA(struct RastPort *rp, int x1, int y1, int x2, int y2, unsigned int color, struct AmbientSupportBase *AmbientSupportBase UNUSED )
{
	int grad;
	int xd, yd, xf, yf;
	int bright1, bright2;
