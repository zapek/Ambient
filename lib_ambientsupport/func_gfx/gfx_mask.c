 ...
 *
 * $Id: gfx_mask.c,v 1.1 2015/03/02 13:50:55 geit Exp $
 */
...
APTR LIB_gfx_MaskCreatePlanar(APTR bm, ULONG width, ULONG height, ULONG depth, struct AmbientSupportBase *AmbientSupportBase)
{
	APTR mbm;
 ...
 */
APTR LIB_gfx_MaskCreateInverted(APTR bm UNUSED, ULONG width UNUSED, ULONG height UNUSED, struct AmbientSupportBase *AmbientSupportBase UNUSED)
{
#if 0
	APTR mbm;
 ...
 */
APTR LIB_gfx_MaskCreateChunky8(UBYTE * chunky, ULONG width, ULONG height, ULONG bgvalue, struct AmbientSupportBase *AmbientSupportBase)
{
	APTR mbm;
 ...
 */
APTR LIB_gfx_MaskCreateCGXFastRam(APTR bm UNUSED, ULONG width UNUSED, ULONG height UNUSED, ULONG bgvalue UNUSED, struct AmbientSupportBase *AmbientSupportBase UNUSED)
{
#if USE_SOLIDDRAG
	APTR mbm;
