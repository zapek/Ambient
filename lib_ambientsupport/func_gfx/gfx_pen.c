 ...
 *
 * $Id: gfx_pen.c,v 1.1 2015/03/02 13:50:55 geit Exp $
 */
...
ULONG LIB_gfx_GetPenSpecValue(struct MUI_RenderInfo *mri, struct MUI_PenSpec *spec, struct AmbientSupportBase *AmbientSupportBase UNUSED )
{
	LONG p = -1;
